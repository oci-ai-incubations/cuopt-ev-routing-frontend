// Sky EV Charging Station Data - Real data from Monitor Locations and Utilisation files
...
export const skyEVStations: EVChargingStation[] = [
  {
    id: 1,
    lat: 51.901291,
    lng: -0.508598,
...
export const skyEVUtilisation: EVUtilisationRecord[] = [
  {
 ...
 */
export function evStationsToStops(stations: EVChargingStation[] = skyEVStations) {
