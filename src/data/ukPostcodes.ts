...
export const ukPostcodeAreas: PostcodeArea[] = [
  ...
  { code: 'WC', name: 'West Central London', region: 'London', lat: 51.5165, lng: -0.12 },

  // LONDON - Compass Areas
  { code: 'E', name: 'East London', region: 'London', lat: 51.545, lng: 0.0553 },
  { code: 'N', name: 'North London', region: 'London', lat: 51.5758, lng: -0.099 },
  { code: 'NW', name: 'North West London', region: 'London', lat: 51.552, lng: -0.21 },
  { code: 'SE', name: 'South East London', region: 'London', lat: 51.459, lng: -0.013 },
  { code: 'SW', name: 'South West London', region: 'London', lat: 51.4613, lng: -0.165 },
  { code: 'W', name: 'West London', region: 'London', lat: 51.513, lng: -0.22 },

  // LONDON - Outer
  { code: 'BR', name: 'Bromley', region: 'London', lat: 51.4039, lng: 0.0198 },
  { code: 'CR', name: 'Croydon', region: 'London', lat: 51.3762, lng: -0.0982 },
  { code: 'DA', name: 'Dartford', region: 'London', lat: 51.4462, lng: 0.219 },
  { code: 'EN', name: 'Enfield', region: 'London', lat: 51.6538, lng: -0.0799 },
  { code: 'HA', name: 'Harrow', region: 'London', lat: 51.5788, lng: -0.3418 },
  { code: 'IG', name: 'Ilford', region: 'London', lat: 51.559, lng: 0.0741 },
  ...
  // SOUTH EAST
  { code: 'AL', name: 'St Albans', region: 'South East', lat: 51.752, lng: -0.3366 },
  ...
  { code: 'HP', name: 'Hemel Hempstead', region: 'South East', lat: 51.753, lng: -0.4689 },
  { code: 'LU', name: 'Luton', region: 'South East', lat: 51.8787, lng: -0.42 },
  ...
  { code: 'OX', name: 'Oxford', region: 'South East', lat: 51.752, lng: -1.2577 },
  { code: 'PO', name: 'Portsmouth', region: 'South East', lat: 50.8198, lng: -1.088 },
  ...
  { code: 'TR', name: 'Truro', region: 'South West', lat: 50.2632, lng: -5.051 },
  ...
  { code: 'HR', name: 'Hereford', region: 'West Midlands', lat: 52.0565, lng: -2.716 },
  ...
  { code: 'WR', name: 'Worcester', region: 'West Midlands', lat: 52.192, lng: -2.2216 },
  { code: 'WS', name: 'Walsall', region: 'West Midlands', lat: 52.5861, lng: -1.9824 },
  { code: 'WV', name: 'Wolverhampton', region: 'West Midlands', lat: 52.587, lng: -2.1288 },
  ...
  // YORKSHIRE & HUMBER
  { code: 'BD', name: 'Bradford', region: 'Yorkshire', lat: 53.796, lng: -1.7594 },
  { code: 'DN', name: 'Doncaster', region: 'Yorkshire', lat: 53.5228, lng: -1.1285 },
  { code: 'HD', name: 'Huddersfield', region: 'Yorkshire', lat: 53.645, lng: -1.7798 },
  { code: 'HG', name: 'Harrogate', region: 'Yorkshire', lat: 53.9921, lng: -1.5418 },
  { code: 'HU', name: 'Hull', region: 'Yorkshire', lat: 53.7676, lng: -0.3274 },
  { code: 'HX', name: 'Halifax', region: 'Yorkshire', lat: 53.721, lng: -1.8563 },
  ...
  { code: 'YO', name: 'York', region: 'Yorkshire', lat: 53.96, lng: -1.0873 },

  // NORTH WEST
  { code: 'BB', name: 'Blackburn', region: 'North West', lat: 53.75, lng: -2.4833 },
  { code: 'BL', name: 'Bolton', region: 'North West', lat: 53.578, lng: -2.4299 },
  ...
  { code: 'WA', name: 'Warrington', region: 'North West', lat: 53.39, lng: -2.597 },
  ...
  { code: 'DD', name: 'Dundee', region: 'Scotland', lat: 56.462, lng: -2.9707 },
  { code: 'DG', name: 'Dumfries', region: 'Scotland', lat: 55.07, lng: -3.61 },
  ...
  { code: 'HS', name: 'Outer Hebrides', region: 'Scotland', lat: 57.76, lng: -7.02 },
  ...
  { code: 'PH', name: 'Perth', region: 'Scotland', lat: 56.395, lng: -3.4308 },
  { code: 'TD', name: 'Galashiels', region: 'Scotland', lat: 55.6186, lng: -2.8046 },
  { code: 'ZE', name: 'Shetland', region: 'Scotland', lat: 60.388, lng: -1.066 },
  ...
  // CROWN DEPENDENCIES
  { code: 'GY', name: 'Guernsey', region: 'Channel Islands', lat: 49.453, lng: -2.535 },
...
export const ukMajorCities = [
  ...
  { name: 'Bradford', lat: 53.796, lng: -1.7594, population: 537173 },
  ...
  { name: 'Portsmouth', lat: 50.8198, lng: -1.088, population: 238800 },
  ...
  { name: 'Wolverhampton', lat: 52.587, lng: -2.1288, population: 262008 },
...
export function generateUKStops(
  ...
  if (centerLat && centerLng && radiusKm) {
    ...
    availableAreas = availableAreas.filter((area) => {
      const dist = Math.sqrt(Math.pow(area.lat - centerLat, 2) + Math.pow(area.lng - centerLng, 2));
...
export const belronJobTypes = {
  ...
  REPLACEMENT: {
    ...
    recalibrationRate: 0.6, // 60% of replacements need recalibration
    revenue: 350,
    margin: 0.4,
  },
  RECALIBRATION: {
