...
export const performanceBaselines: PerformanceMetric[] = [
  ...
  },
  {
    ...
    payloadSizeMB: 2.7,
    solveTimeSeconds: 95,
    throughputStopsPerSec: 2.6,
    status: 'success',
  },
  {
    stopCount: 500,
    payloadSizeMB: 10.8,
    solveTimeSeconds: 140,
    throughputStopsPerSec: 3.6,
    status: 'success',
  },
  // Medium to large datasets
  {
    ...
    throughputStopsPerSec: 5.0,
    status: 'success',
  },
  {
    stopCount: 2500,
    payloadSizeMB: 230.43,
    solveTimeSeconds: 320,
    throughputStopsPerSec: 7.8,
    status: 'success',
  },
  {
    stopCount: 5000,
    payloadSizeMB: 921.96,
    solveTimeSeconds: 480,
    throughputStopsPerSec: 10.4,
    status: 'success',
  },
  {
    stopCount: 7500,
    payloadSizeMB: 1989.97,
    solveTimeSeconds: 600,
    throughputStopsPerSec: 12.5,
    status: 'success',
  },
  {
    stopCount: 10000,
    payloadSizeMB: 1004.8,
    solveTimeSeconds: 720,
    throughputStopsPerSec: 13.9,
    status: 'success',
  }, // Clustered
];
...
export const ukCitiesData = [
  ...
  { city: 'Camden', postcode: 'NW1', lat: 51.539, lng: -0.1426, region: 'London' },
  { city: 'Greenwich', postcode: 'SE10', lat: 51.4826, lng: -0.0077, region: 'London' },
  { city: 'Stratford', postcode: 'E15', lat: 51.543, lng: -0.0005, region: 'London' },
  { city: 'Heathrow', postcode: 'TW6', lat: 51.47, lng: -0.4543, region: 'London' },
  ...
  { city: 'Dundee', postcode: 'DD1', lat: 56.462, lng: -2.9707, region: 'Scotland' },
  ...
  { city: 'Portsmouth', postcode: 'PO1', lat: 50.8198, lng: -1.088, region: 'South' },
  ...
  { city: 'Bradford', postcode: 'BD1', lat: 53.796, lng: -1.7594, region: 'Yorkshire' },
  ...
  { city: 'Oxford', postcode: 'OX1', lat: 51.752, lng: -1.2577, region: 'South' },
  ...
  { city: 'Luton', postcode: 'LU1', lat: 51.8787, lng: -0.42, region: 'South East' },
  { city: 'York', postcode: 'YO1', lat: 53.96, lng: -1.0873, region: 'Yorkshire' },
...
const MUMBAI_LAND_ZONES = [
  ...
  { minLat: 19.03, maxLat: 19.1, minLng: 72.875, maxLng: 72.92 },
  // Powai, Vikhroli - tech hub area
  { minLat: 19.1, maxLat: 19.14, minLng: 72.89, maxLng: 72.93 },
...
const CHENNAI_LAND_ZONES = [
  ...
  { minLat: 13.0, maxLat: 13.1, minLng: 80.22, maxLng: 80.28 },
  // North Chennai
  { minLat: 13.08, maxLat: 13.2, minLng: 80.18, maxLng: 80.28 },
  // West Chennai (Anna Nagar, Vadapalani)
  { minLat: 13.02, maxLat: 13.12, minLng: 80.18, maxLng: 80.24 },
  // South Chennai (Adyar, Velachery)
  { minLat: 12.92, maxLat: 13.02, minLng: 80.2, maxLng: 80.26 },
  // Tambaram-Chromepet
  { minLat: 12.85, maxLat: 12.95, minLng: 80.1, maxLng: 80.18 },
];
...
const SYDNEY_LAND_ZONES = [
  ...
  { minLat: -33.88, maxLat: -33.78, minLng: 150.95, maxLng: 151.1 },
  // South Sydney (Bankstown, Hurstville)
  { minLat: -34.0, maxLat: -33.9, minLng: 151.0, maxLng: 151.15 },
  // Northern Suburbs
  { minLat: -33.82, maxLat: -33.7, minLng: 151.12, maxLng: 151.25 },
  // Hills District
  { minLat: -33.75, maxLat: -33.65, minLng: 150.95, maxLng: 151.1 },
];
...
const SAN_FRANCISCO_LAND_ZONES = [
  // SF Peninsula
  { minLat: 37.7, maxLat: 37.82, minLng: -122.48, maxLng: -122.38 },
  // Oakland, Berkeley
  { minLat: 37.78, maxLat: 37.9, minLng: -122.3, maxLng: -122.18 },
  // South Bay (San Jose)
  { minLat: 37.28, maxLat: 37.45, minLng: -122.05, maxLng: -121.85 },
  // Peninsula (Palo Alto, Menlo Park)
  { minLat: 37.4, maxLat: 37.55, minLng: -122.2, maxLng: -122.05 },
  // Fremont, Newark
...
const LOS_ANGELES_LAND_ZONES = [
  // Downtown LA
  { minLat: 33.98, maxLat: 34.08, minLng: -118.3, maxLng: -118.18 },
  // Hollywood, West Hollywood
  { minLat: 34.08, maxLat: 34.15, minLng: -118.4, maxLng: -118.28 },
  // Pasadena, Glendale
  { minLat: 34.12, maxLat: 34.22, minLng: -118.2, maxLng: -118.05 },
  ...
  // Inland Empire
  { minLat: 33.9, maxLat: 34.05, minLng: -117.95, maxLng: -117.75 },
];

// Global registry of all land zones
const GLOBAL_LAND_ZONES: Record<
  string,
  Array<{ minLat: number; maxLat: number; minLng: number; maxLng: number }>
> = {
...
const COASTAL_CITY_BOUNDS: Record<
  string,
  {
    minLat: number;
    maxLat: number;
...
> = {
  ...
  new_york: { minLat: 40.56, maxLat: 41.05, minLng: -74.25, maxLng: -73.7, biasLng: 'west' },
  // Los Angeles: Bias eastward to avoid Pacific
  los_angeles: { minLat: 33.7, maxLat: 34.35, minLng: -118.7, maxLng: -117.7, biasLng: 'east' },
  // San Francisco: Bias eastward
  san_francisco: { minLat: 37.35, maxLat: 38.0, minLng: -122.55, maxLng: -121.8, biasLng: 'east' },
  ...
  seattle: { minLat: 47.35, maxLat: 47.85, minLng: -122.5, maxLng: -121.9, biasLng: 'east' },
  // Sydney: Bias westward
  sydney: { minLat: -34.15, maxLat: -33.55, minLng: 150.6, maxLng: 151.35, biasLng: 'west' },
  ...
  chennai: { minLat: 12.85, maxLat: 13.3, minLng: 80.05, maxLng: 80.35, biasLng: 'west' },
  // London: No major water issues but has Thames
  london: { minLat: 51.28, maxLat: 51.7, minLng: -0.55, maxLng: 0.3 },
};
...
export const clusterPerformanceData = [
  ...
  { clusterId: 3, stops: 2681, payloadMB: 260.1, solveTimeSeconds: 111.3 },
];
